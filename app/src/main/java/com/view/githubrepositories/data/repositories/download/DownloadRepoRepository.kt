...
import com.view.githubrepositories.data.repositories.download.file.Kbs
import com.view.githubrepositories.data.repositories.download.file.SizeFile
...
interface DownloadRepoRepository<T> {
    ...
    class Base(
        ...
        private val file: com.view.githubrepositories.data.repositories.download.file.File,
